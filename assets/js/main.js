document.addEventListener('DOMContentLoaded', function() {
    ...
    // Form removed - No contact form needed
    ...
    function createPlaceholderImage() {
        ...
        projectImages.forEach(img => {
            img.addEventListener('error', function() {
                ...
                gradient.addColorStop(0, '#9B5442');   // Terracota rojizo oscuro
                gradient.addColorStop(1, '#B87161');   // Terracota claro rojizo
            ...
            particleSections.forEach(section => {
                if (section && window.particlesJS) {
                    ...
                    if (section.id === 'habilidades') {
                        config.particles.color.value = "#B87161";
                        config.particles.line_linked.color = "#B87161";
